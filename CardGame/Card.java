...
public class Card implements Comparable<Card>{
    ...
    // private static Image backImage = new Image("file:../img/back.jpg");
    private static Image backImage = new Image(Card.class.getResourceAsStream("img/back.jpg"));
    ...
    public Image getImage(){
        ...
        if(cardImage == null)
            cardImage = new Image(
                    ...
                    Card.class.getResourceAsStream(("img/" + verbose_rank[rank]+ verbose_suit[suit] + ".jpg").toLowerCase()));
        return cardImage;
    }
